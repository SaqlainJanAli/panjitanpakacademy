  ...
  return (
    <div style={{ margin: "20px" }}>
      <Card style={{ marginBottom: "20px" }}>
        <Card.Header>
          <h5>Birthdays of Ayimah Athaar</h5>
        </Card.Header>
        <Card.Body>
          <p>
            Explore the significant occasions of the birth of Ayimah Athaar,
            including:
          </p>
          <ul>
            {AayimmahNames.map((ayimah, index) => (
              <li key={index}>{ayimah}</li>
            ))}
          </ul>
        </Card.Body>
      </Card>
      ...
      <Card style={{ marginBottom: "20px" }}>
        <Card.Header>
          <h5>Martyrdom Anniversaries</h5>
        </Card.Header>
        <Card.Body>
          <p>
            Reflect on the solemn occasions of the martyrdom of Ayimah Athaar,
            including:
          </p>
          <ul>
            {AayimmahNames.map((ayimah, index) => (
              <li key={index}>{`Martyrdom of ${ayimah}`}</li>
            ))}
          </ul>
        </Card.Body>
      </Card>
      ...
      <Card style={{ marginBottom: "20px" }}>
        <Card.Header>
          <h5>Stories and Lessons</h5>
        </Card.Header>
        <Card.Body>
          <p>
            Immerse yourself in the captivating stories and timeless lessons
            from the lives of Ayimah Athaar, highlighting their unwavering
            commitment to justice, wisdom, and piety.
          </p>
        </Card.Body>
      </Card>
      ...
      <Card style={{ marginBottom: "20px" }}>
        ...
        <Card.Body>
          <p>
            Enhance your understanding with recommended books on Ayimah Athaar,
            offering deep insights into their lives, teachings, and the
