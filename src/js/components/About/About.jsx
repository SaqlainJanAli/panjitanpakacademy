          ...
          <div className="row">
            <div className="col-xs-12 col-sm-12 col-md-8 col-lg-8">
              <div className="aboutStatement ">
                <div>
                  <h4>ABOUT PANJITANPAK ONLINE ISLAMIC ACADEMY</h4>
                  <p>
                    ...
                    safety and veil reasons. PanjitanPak ONLINE ISLAMIC ACADEMY
                    is an amazing site that enables Muslims from all over the
                    world to read the Quran using Tajweed. The following
                    programmes are offered by the Online Quran Academy and are
                    open to all interested students: Quran Reading & Recitation
                    (Nazra Quran), Nurani Qaida, Memorizing Quran, Translation &
